...
const SAMPLE_PRODUCTS = [
  {
    ...
    benefits: [
      ...
      'Dr. PPS Tomar recommended placement guide included',
    ],
    price: 1499,
    offerPrice: 999,
    images: [],
  ...
  },
  {
    ...
    category: 'yantras',
    description: {
      en: 'A pure Sphatik (transparent quartz) Shivalinga of 50-60g, hand-polished and energised with Maha Mrityunjaya mantras. Comes with a detailed Vastu placement guide by Dr. PPS Tomar. Ideal for home pooja, business desk, and gift.',
