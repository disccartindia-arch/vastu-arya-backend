'use client';
// Admin ai-settings page - full implementation in your original codebase
// This stub ensures the route compiles. Replace with your full page component.
import Link from 'next/link';
export default function AdminPage() {
  return (
    <div className="p-6">
      <h1 className="font-display text-2xl font-bold text-gray-800 mb-4 capitalize">ai-settings</h1>
