'use client';
// app/(public)/checkout/CheckoutClient.tsx — Fixed checkout flow
      ...
      <>
        ...
        <div className="min-h-screen bg-cream flex items-center justify-center">
          <div className="text-center py-20">
            ...
            <button
              onClick={() => router.push('/vastu-store')}
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <h2 className="font-semibold text-text-dark mb-4">
                  {lang === 'en' ? 'Delivery Information' : 'डिलीवरी जानकारी'}
                </h2>
              ...
              <div className="grid grid-cols-3 gap-3 text-center text-xs text-text-light">
                <div className="bg-white rounded-xl p-3 shadow-sm flex flex-col items-center gap-1">
                  <Shield size={16} className="text-green-500" /> Secure Payment
                </div>
                <div className="bg-white rounded-xl p-3 shadow-sm flex flex-col items-center gap-1">
                  <Truck size={16} className="text-primary" /> Fast Delivery
                </div>
                <div className="bg-white rounded-xl p-3 shadow-sm flex flex-col items-center gap-1">
                  <RefreshCw size={16} className="text-blue-500" /> Easy Returns
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3 mb-4">
                {items.map(i => (
                  <div key={i.product._id} className="flex items-center gap-3">
                    ...
                    <span className="font-semibold text-text-dark text-sm flex-shrink-0">
                      {formatPrice(i.product.offerPrice * i.qty)}
                    </span>
                  </div>
                ))}
              </div>
