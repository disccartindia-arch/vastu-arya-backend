...
export default function Page() {
  return (<ServicePageTemplate
    icon="✅" badge="Expert Service"
    title="Complete Vastu Check"
    subtitle="Expert consultation by IVAF Certified Dr. PPS Tomar"
    description="Get expert guidance from Dr. PPS Tomar - IVAF Certified Vastu and astrology expert with 15+ years of experience and 73,000+ clients transformed across India."
    price={5100} originalPrice={51000} duration="45 minutes"
