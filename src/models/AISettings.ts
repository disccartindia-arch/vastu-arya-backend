...
Format your response as JSON:
{
  ...
  ctaText: { type: String, default: 'Book a Consultation with Dr. PPS Tomar' },
  ...
  quickSuggestions: {
    type: [String],
    default: ['Financial problems','Relationship issues','Health problems','Career obstacles','Sleep disturbances','Family conflicts','Business losses','Child education'],
  },
  trustedAdviceBlocks: {
    type: [{ title: String, content: String }],
    default: [
      { title: 'North Zone — Wealth Activation', content: 'Keep the North zone of your home clutter-free. Place a money plant or Kuber Yantra here to activate financial energy.' },
      { title: 'Main Entrance — Welcoming Energy', content: 'Ensure your main door opens inward, is well-lit, and has no obstruction. Place Ganesha facing outward at the entrance.' },
    ],
  },
}, { timestamps: true });
